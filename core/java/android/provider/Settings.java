...
public final class Settings {
    ...
    /**
     * @hide - Private call() method on SettingsProvider to read from 'revolt' table.
     */
    public static final String CALL_METHOD_GET_REVOLT = "GET_revolt";
    ...
    /** @hide - Private call() method to write to 'revolt' table */
    public static final String CALL_METHOD_PUT_REVOLT = "PUT_revolt";
    ...
    /**
     * REVOLT settings, containing REVOLT specific preferences.  This
     * table holds simple name/value pairs.  There are convenience
     * functions for accessing individual settings entries.
     */
    public static final class REVOLT extends NameValueTable {
        public static final String SYS_PROP_SETTING_VERSION = "sys.settings_system_version";
         ...
         */
        public static final Uri CONTENT_URI =
            Uri.parse("content://" + AUTHORITY + "/revolt");

        private static final NameValueCache sNameValueCache = new NameValueCache(
                SYS_PROP_SETTING_VERSION,
                CONTENT_URI,
                CALL_METHOD_GET_REVOLT,
                CALL_METHOD_PUT_REVOLT);
