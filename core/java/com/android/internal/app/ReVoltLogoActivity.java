...
public class ReVoltLogoActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        logo.setImageResource(com.android.internal.R.drawable.revolt_logo);
        ...
        logo.setOnLongClickListener(new View.OnLongClickListener() {
            ...
            public boolean onLongClick(View v) {
                try {
                    ...
                    android.util.Log.e("ReVoltLogoActivity", "Couldn't catch a break.");
                }
                finish();
                return true;
            }
