...
public final class PowerManagerService extends IPowerManager.Stub
    ...
    public void systemReady(TwilightService twilight, DreamManagerService dreamManager) {
        synchronized (mLock) {
            ...
            resolver.registerContentObserver(Settings.REVOLT.getUriFor(
                    Settings.REVOLT.SYSTEM_POWER_ENABLE_CRT_OFF),
                    false, mSettingsObserver, UserHandle.USER_ALL);
            resolver.registerContentObserver(Settings.REVOLT.getUriFor(
    ...
    private void updateSettingsLocked() {
        ...
        mElectronBeamOffEnabled = Settings.REVOLT.getIntForUser(resolver,
                Settings.REVOLT.SYSTEM_POWER_ENABLE_CRT_OFF,
                mElectronBeamFadesConfig ? 1 : 0,
                UserHandle.USER_CURRENT) == 1;
        mElectronBeamMode = Settings.REVOLT.getIntForUser(resolver,
                Settings.REVOLT.SYSTEM_POWER_CRT_MODE,
