...
public class KeyguardViewManager {
    ...
    private void updateSettings() {
        mLockscreenNotifications = Settings.REVOLT.getInt(mContext.getContentResolver(),
                Settings.REVOLT.LOCKSCREEN_NOTIFICATIONS, mLockscreenNotifications ? 1 : 0) == 1;
        ...
        mSeeThrough = Settings.REVOLT.getInt(mContext.getContentResolver(),
                Settings.REVOLT.LOCKSCREEN_SEE_THROUGH, 0) == 1;
        mBlurRadius = Settings.REVOLT.getInt(mContext.getContentResolver(),
                Settings.REVOLT.LOCKSCREEN_BLUR_RADIUS, mBlurRadius);
    ...
    boolean enableLockScreenRotation = Settings.REVOLT.getInt(mContext.getContentResolver(),
                Settings.REVOLT.LOCKSCREEN_ROTATION, 0) != 0;
