...
public class PhoneStatusBar extends BaseStatusBar implements DemoMode,
    ...
    public void showClock(boolean show) {
        ...
        boolean rightClock = (Settings.REVOLT.getInt(mContext.getContentResolver(),
                Settings.REVOLT.STATUSBAR_CLOCK_STYLE, 1) == 1);
        boolean centerClock = (Settings.REVOLT.getInt(mContext.getContentResolver(),
                Settings.REVOLT.STATUSBAR_CLOCK_STYLE, 1) == 2);
...
//            Log.d(TAG, "size=" + newIconSize + " padding=" + newIconHPadding);
    ...
    class SettingsObserver extends ContentObserver {
        ...
        void observe() {
            ...
            resolver.registerContentObserver(Settings.REVOLT.getUriFor(
                    Settings.REVOLT.TOGGLES_STYLE), false, this);
            resolver.registerContentObserver(Settings.REVOLT.getUriFor(
    ...
    public void updateSettings() {
        ...
        mWantsNavigationBar = Settings.REVOLT.getBoolean(cr, Settings.REVOLT.ENABLE_NAVIGATION_BAR, hasNav);
        mEnableNavring = Settings.REVOLT.getBoolean(mContext.getContentResolver(),
                Settings.REVOLT.ENABLE_NAVRING, true);
    }
