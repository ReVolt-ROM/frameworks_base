...
class GlobalActions implements DialogInterface.OnDismissListener, DialogInterface.OnClickListener  {
    ...
    public GlobalActions(Context context, WindowManagerFuncs windowManagerFuncs) {
        ...
        mContext.getContentResolver().registerContentObserver(
                Settings.Global.getUriFor(Settings.REVOLT.IMMERSIVE_MODE), true,
    ...
    private GlobalActionsDialog createDialog() {
        ...
        mScreenrecordOption = Settings.REVOLT.getInt(resolver, Settings.REVOLT.SCREENRECORD_MODE_OPTIONS, 0);
        ...
        mImmersiveModeOn = new ToggleAction(
            ...
            void onToggle(boolean on) {
                Settings.REVOLT.putBoolean(mContext.getContentResolver(), Settings.REVOLT.IMMERSIVE_MODE, on);
            }
   ...
   /**
    ...
    private void onImmersiveModeChanged() {
        ...
        boolean immersiveModeOn = Settings.REVOLT.getBoolean(
                mContext.getContentResolver(),
