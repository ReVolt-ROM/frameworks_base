...
public class BatteryTextMeterView extends TextView implements BatteryStateChangeCallback {
    ...
    protected void onAttachedToWindow() {
        ...
        getContext().getContentResolver().registerContentObserver(
                Settings.REVOLT.getUriFor(Settings.REVOLT.BATTERY_PERCENTAGE_INDICATOR),
                false, mObserver);
        getContext().getContentResolver().registerContentObserver(
                Settings.REVOLT.getUriFor(Settings.REVOLT.BATTERY_PERCENTAGE_INDICATOR_PLUGGED),
                false, mObserver);
        updateSettings();
    }
    ...
    private void updateSettings() {
        mEnabled = Settings.REVOLT.getBoolean(mContext.getContentResolver(),
                        Settings.REVOLT.BATTERY_PERCENTAGE_INDICATOR, false);
        mPluggedEnabled = Settings.REVOLT.getBoolean(mContext.getContentResolver(),
                        Settings.REVOLT.BATTERY_PERCENTAGE_INDICATOR_PLUGGED, false);
        refreshView();
    }
