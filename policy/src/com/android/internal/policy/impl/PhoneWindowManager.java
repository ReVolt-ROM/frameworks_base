...
public class PhoneWindowManager implements WindowManagerPolicy {
    ...
    class SettingsObserver extends ContentObserver {
        ...
        void observe() {
            ...
            resolver.registerContentObserver(Settings.REVOLT.getUriFor(
                    Settings.REVOLT.KEY_HOME_LONG_PRESS_ACTION), false, this,
                    UserHandle.USER_ALL);
            resolver.registerContentObserver(Settings.REVOLT.getUriFor(
                    Settings.REVOLT.KEY_HOME_DOUBLE_TAP_ACTION), false, this,
                    UserHandle.USER_ALL);
            resolver.registerContentObserver(Settings.REVOLT.getUriFor(
                    Settings.REVOLT.KEY_BACK_LONG_PRESS_ACTION), false, this,
                    UserHandle.USER_ALL);
            resolver.registerContentObserver(Settings.REVOLT.getUriFor(
                    Settings.REVOLT.KEY_MENU_ACTION), false, this,
                    UserHandle.USER_ALL);
            resolver.registerContentObserver(Settings.REVOLT.getUriFor(
                    Settings.REVOLT.KEY_MENU_LONG_PRESS_ACTION), false, this,
                    UserHandle.USER_ALL);
            resolver.registerContentObserver(Settings.REVOLT.getUriFor(
                    Settings.REVOLT.KEY_ASSIST_ACTION), false, this,
                    UserHandle.USER_ALL);
            resolver.registerContentObserver(Settings.REVOLT.getUriFor(
                    Settings.REVOLT.KEY_ASSIST_LONG_PRESS_ACTION), false, this,
                    UserHandle.USER_ALL);
            resolver.registerContentObserver(Settings.REVOLT.getUriFor(
                    Settings.REVOLT.KEY_APP_SWITCH_ACTION), false, this,
                    UserHandle.USER_ALL);
            resolver.registerContentObserver(Settings.REVOLT.getUriFor(
                    Settings.REVOLT.KEY_APP_SWITCH_LONG_PRESS_ACTION), false, this,
                    UserHandle.USER_ALL);
            resolver.registerContentObserver(Settings.REVOLT.getUriFor(
                    Settings.REVOLT.HARDWARE_KEY_REBINDING), false, this,
                    UserHandle.USER_ALL);
            resolver.registerContentObserver(Settings.REVOLT.getUriFor(
                    Settings.REVOLT.VOLUME_WAKE_SCREEN), false, this,
                    UserHandle.USER_ALL);
            resolver.registerContentObserver(Settings.REVOLT.getUriFor(
                    Settings.REVOLT.VOLUME_MUSIC_CONTROLS), false, this,
                    UserHandle.USER_ALL);
            resolver.registerContentObserver(Settings.REVOLT.getUriFor(
                    Settings.REVOLT.DOUBLE_TAP_VOLUME_KEYS), false, this,
                    UserHandle.USER_ALL);
            resolver.registerContentObserver(Settings.REVOLT.getUriFor(
                    Settings.REVOLT.ENABLE_NAVIGATION_BAR), false, this,
                    UserHandle.USER_ALL);
            resolver.registerContentObserver(Settings.REVOLT.getUriFor(
                    Settings.REVOLT.NAVIGATION_BAR_HEIGHT), false, this,
                    UserHandle.USER_ALL);
            resolver.registerContentObserver(Settings.REVOLT.getUriFor(
                    Settings.REVOLT.NAVIGATION_BAR_HEIGHT_LANDSCAPE), false, this,
                    UserHandle.USER_ALL);
            resolver.registerContentObserver(Settings.REVOLT.getUriFor(
                    Settings.REVOLT.NAVIGATION_BAR_WIDTH), false, this,
                    UserHandle.USER_ALL);
    ...
    private void updateKeyAssignments() {
        ...
        boolean keyRebindingEnabled = Settings.REVOLT.getIntForUser(resolver,
                Settings.REVOLT.HARDWARE_KEY_REBINDING, 0, UserHandle.USER_CURRENT) == 1;
        ...
        if (hasHome) {
            mLongPressOnHomeBehavior = Settings.REVOLT.getIntForUser(resolver,
                    Settings.REVOLT.KEY_HOME_LONG_PRESS_ACTION,
                    hasAppSwitch ? KEY_ACTION_NOTHING : KEY_ACTION_APP_SWITCH,
                    UserHandle.USER_CURRENT);
            mDoubleTapOnHomeBehavior = Settings.REVOLT.getIntForUser(resolver,
                    Settings.REVOLT.KEY_HOME_DOUBLE_TAP_ACTION,
        ...
        if (hasMenu) {
            mPressOnMenuBehavior = Settings.REVOLT.getIntForUser(resolver,
                    Settings.REVOLT.KEY_MENU_ACTION,
                    KEY_ACTION_MENU, UserHandle.USER_CURRENT);
            mLongPressOnMenuBehavior = Settings.REVOLT.getIntForUser(resolver,
                    Settings.REVOLT.KEY_MENU_LONG_PRESS_ACTION,
        ...
        if (hasBack) {
            mLongPressOnBackBehavior = Settings.REVOLT.getIntForUser(resolver,
                    Settings.REVOLT.KEY_BACK_LONG_PRESS_ACTION, KEY_ACTION_NOTHING,
                    UserHandle.USER_CURRENT);
            mHasMenuKeyEnabled = mLongPressOnBackBehavior == KEY_ACTION_MENU
                    || mDoubleTapOnHomeBehavior == KEY_ACTION_MENU;
        }
        if (hasAssist) {
            mPressOnAssistBehavior = Settings.REVOLT.getIntForUser(resolver,
                    Settings.REVOLT.KEY_ASSIST_ACTION,
                    KEY_ACTION_SEARCH, UserHandle.USER_CURRENT);
            mLongPressOnAssistBehavior = Settings.REVOLT.getIntForUser(resolver,
                    Settings.REVOLT.KEY_ASSIST_LONG_PRESS_ACTION,
        ...
        if (hasAppSwitch) {
            mPressOnAppSwitchBehavior = Settings.REVOLT.getIntForUser(resolver,
                    Settings.REVOLT.KEY_APP_SWITCH_ACTION,
                    KEY_ACTION_APP_SWITCH, UserHandle.USER_CURRENT);
            mLongPressOnAppSwitchBehavior = Settings.REVOLT.getIntForUser(resolver,
                    Settings.REVOLT.KEY_APP_SWITCH_LONG_PRESS_ACTION,
    ...
    public void updateSettings() {
        ...
        synchronized (mLock) {
            ...
            mWantsNavigationBar = Settings.REVOLT.getBoolean(resolver,
                    Settings.REVOLT.ENABLE_NAVIGATION_BAR, mHasNavigationBar);
            ...
            mVolumeKeysDoubleTapEnabled = Settings.REVOLT.getBooleanForUser(resolver,
                    Settings.REVOLT.DOUBLE_TAP_VOLUME_KEYS, true, UserHandle.USER_CURRENT);

            mVolumeWakeScreen = Settings.REVOLT.getBoolean(resolver,
                    Settings.REVOLT.VOLUME_WAKE_SCREEN, false);
            mVolBtnMusicControls = Settings.REVOLT.getBoolean(resolver,
                    Settings.REVOLT.VOLUME_MUSIC_CONTROLS, false);
        ...
        int NavHeight = Settings.REVOLT.getInt(resolver,
                Settings.REVOLT.NAVIGATION_BAR_HEIGHT, 0);
        int NavHeightLand = Settings.REVOLT.getInt(resolver,
                Settings.REVOLT.NAVIGATION_BAR_HEIGHT_LANDSCAPE, 0);
        int NavWidth = Settings.REVOLT.getInt(resolver,
