    ...
    private class SettingsObserver extends ContentObserver {
        ...
        void observe() {
            ...
            resolver.registerContentObserver(Settings.REVOLT.getUriFor(
                    Settings.REVOLT.ENABLE_APP_CIRCLE_BAR), false, this);
            resolver.registerContentObserver(Settings.REVOLT.getUriFor(
                    Settings.REVOLT.WHITELIST_APP_CIRCLE_BAR), false, this);
            update();
        }
        ...
        public void update() {
            final ContentResolver resolver = mContext.getContentResolver();
            setAppBarVisibility(Settings.REVOLT.getIntForUser(
                    resolver, Settings.REVOLT.ENABLE_APP_CIRCLE_BAR, 0,
                    UserHandle.USER_CURRENT_OR_SELF) == 1);
            String includedApps = Settings.REVOLT.getStringForUser(resolver,
                    Settings.REVOLT.WHITELIST_APP_CIRCLE_BAR,
