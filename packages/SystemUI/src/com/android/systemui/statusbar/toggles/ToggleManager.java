...
public class ToggleManager {
    ...
    public void updateSettings() {
        ...
        mUserToggles = Settings.REVOLT.getString(resolver, Settings.REVOLT.QUICK_TOGGLES);
        if(mUserToggles == null) {
            mUserToggles = "";
        }
        int columnCount = Settings.REVOLT.getInt(resolver, Settings.REVOLT.QUICK_TOGGLES_PER_ROW,
                mContext.getResources().getInteger(R.integer.quick_settings_num_columns));

        mStyle = Settings.REVOLT.getInt(resolver, Settings.REVOLT.TOGGLES_STYLE,
    ...
    class SettingsObserver extends ContentObserver {
        ...
        void observe() {
            ...
            resolver.registerContentObserver(Settings.REVOLT
                    .getUriFor(Settings.REVOLT.QUICK_TOGGLES),
                    false, this);
            resolver.registerContentObserver(Settings.REVOLT
                    .getUriFor(Settings.REVOLT.QUICK_TOGGLES_PER_ROW),
                    false, this);
            resolver.registerContentObserver(Settings.REVOLT
                    .getUriFor(Settings.REVOLT.TOGGLES_STYLE),
                    false, this);
            updateSettings();
        }
    ...
    public static int getTextSize(Context c) {
        int columnCount = Settings.REVOLT.getInt(c.getContentResolver(),
                Settings.REVOLT.QUICK_TOGGLES_PER_ROW,
