...
public abstract class BaseToggle
    ...
    private void updateSettings() {
        ...
        mCollapsePref = Settings.REVOLT.getBoolean(resolver,
                Settings.REVOLT.SHADE_COLLAPSE_ALL, false);
        mVibratePref = Settings.REVOLT.getBoolean(resolver,
                Settings.REVOLT.QUICK_TOGGLE_VIBRATE, false);
    ...
    class SettingsObserver extends ContentObserver {
        ...
        void observe() {
            ...
            resolver.registerContentObserver(Settings.REVOLT
                    .getUriFor(Settings.REVOLT.SHADE_COLLAPSE_ALL),
                    false, this);
            resolver.registerContentObserver(Settings.REVOLT
                    .getUriFor(Settings.REVOLT.QUICK_TOGGLE_VIBRATE),
                    false, this);
