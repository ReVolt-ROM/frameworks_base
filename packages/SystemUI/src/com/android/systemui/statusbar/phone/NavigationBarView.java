...
public class NavigationBarView extends LinearLayout {
    ...
    public void setDisabledFlags(int disabledFlags, boolean force) {
        ...
        final boolean showNotifs = showSearch &&
                Settings.REVOLT.getInt(mContext.getContentResolver(),
                        Settings.REVOLT.LOCKSCREEN_NOTIFICATIONS, 1) == 1 &&
                Settings.REVOLT.getInt(mContext.getContentResolver(),
                        Settings.REVOLT.LOCKSCREEN_NOTIFICATIONS_PRIVACY_MODE, 0) == 0;
    ...
    protected void onAttachedToWindow() {
        ...
        mContext.getContentResolver().registerContentObserver(Settings.REVOLT.getUriFor(REVOLT.NAVIGATION_BAR_DPAD_KEYS),
                false, mSettingsObserver);
    }
    ...
    private void readUserConfig() {
        ...
        mShowDpadKeys = Settings.REVOLT.getBoolean(getContext().getContentResolver(), Settings.REVOLT.NAVIGATION_BAR_DPAD_KEYS, false);
    }
