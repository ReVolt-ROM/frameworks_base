...
public class AppWindow extends LinearLayout implements OnItemClickListener, OnItemLongClickListener {
    ...
    class SettingsObserver extends ContentObserver {
        ...
        void observe() {
            ...
            resolver.registerContentObserver(Settings.REVOLT.getUriFor(
                    Settings.REVOLT.APP_WINDOW[AokpRibbonHelper.WINDOW_COLOR]), false, this);
            resolver.registerContentObserver(Settings.REVOLT.getUriFor(
                    Settings.REVOLT.APP_WINDOW[AokpRibbonHelper.WINDOW_SIZE]), false, this);
            resolver.registerContentObserver(Settings.REVOLT.getUriFor(
                    Settings.REVOLT.APP_WINDOW[AokpRibbonHelper.WINDOW_SPACE]), false, this);
            resolver.registerContentObserver(Settings.REVOLT.getUriFor(
                    Settings.REVOLT.APP_WINDOW[AokpRibbonHelper.WINDOW_ANIMATION]), false, this);
            resolver.registerContentObserver(Settings.REVOLT.getUriFor(
                    Settings.REVOLT.APP_WINDOW[AokpRibbonHelper.WINDOW_ANIMATION_DURATION]), false, this);
        }
         @Override
    ...
    protected void updateSettings() {
        ...
        mColor = Settings.REVOLT.getInt(cr, Settings.REVOLT.APP_WINDOW[AokpRibbonHelper.WINDOW_COLOR], Color.BLACK);
        mAnimDur = Settings.REVOLT.getInt(cr, Settings.REVOLT.APP_WINDOW[AokpRibbonHelper.WINDOW_ANIMATION_DURATION], 50);
        mAnim = Settings.REVOLT.getInt(cr, Settings.REVOLT.APP_WINDOW[AokpRibbonHelper.WINDOW_ANIMATION], 0);
        int size = Settings.REVOLT.getInt(cr, Settings.REVOLT.APP_WINDOW[AokpRibbonHelper.WINDOW_SIZE], 30);
        mSize = (int) (((size * 0.01f) * 150) + 150);
        int margin = Settings.REVOLT.getInt(cr, Settings.REVOLT.APP_WINDOW[AokpRibbonHelper.WINDOW_SPACE], 5);
