...
public class NetworkController extends BroadcastReceiver implements DemoMode {
    ...
    class SettingsObserver extends ContentObserver {
        ...
        void observe() {
            ...
            resolver.registerContentObserver(
                    Settings.REVOLT.getUriFor(Settings.REVOLT.STATUSBAR_HIDE_SIGNAL_BARS), false,
                    this);
            resolver.registerContentObserver(
                    Settings.REVOLT.getUriFor(Settings.REVOLT.STATUSBAR_SIGNAL_SHOW_4G_FOR_LTE), false,
                    this);
            updateSettings();
        }
    ...
    protected void updateSettings() {
        mHideSignal = (Settings.REVOLT.getInt(mContext.getContentResolver(),
                Settings.REVOLT.STATUSBAR_HIDE_SIGNAL_BARS, 0) == 1);
        mShow4gForLte = (Settings.REVOLT.getBoolean(mContext.getContentResolver(),
                Settings.REVOLT.STATUSBAR_SIGNAL_SHOW_4G_FOR_LTE,
