...
public class BatteryMeterView extends View implements DemoMode {
    ...
    public void updateSettings() {
        boolean hideBattery = Settings.REVOLT.getBoolean(mContext.getContentResolver(),
                                Settings.REVOLT.HIDE_BATTERY_ICON, false);
        int batteryStyle = Settings.REVOLT.getInt(getContext().getContentResolver(),
                                Settings.REVOLT.STATUS_BAR_BATTERY_STYLE, 0);
