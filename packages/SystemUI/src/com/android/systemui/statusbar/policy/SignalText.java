...
public class SignalText extends TextView {
    ...
    protected void onAttachedToWindow() {
        ...
        resolver.registerContentObserver(
                Settings.REVOLT.getUriFor(Settings.REVOLT.STATUSBAR_SIGNAL_TEXT), false,
                mSettingsObserver);
        resolver.registerContentObserver(
                Settings.REVOLT.getUriFor(Settings.REVOLT.STATUSBAR_SIGNAL_TEXT_COLOR), false,
                mSettingsObserver);
    ...
    private void updateSettings() {
        ...
        mSignalColor = Settings.REVOLT.getInt(resolver,
                Settings.REVOLT.STATUSBAR_SIGNAL_TEXT_COLOR,
                Color.WHITE);
        ...
        mTextStyle = Settings.REVOLT.getInt(getContext().getContentResolver(),
                Settings.REVOLT.STATUSBAR_SIGNAL_TEXT, STYLE_HIDE);
    }
