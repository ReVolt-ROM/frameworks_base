    ...
    class Configuration extends ContentObserver {
        ...
        void observe() {
            ...
            resolver.registerContentObserver(Settings.REVOLT.getUriFor(
                    Settings.REVOLT.LOCKSCREEN_NOTIFICATIONS_SHOW_ALWAYS), false, this);
            resolver.registerContentObserver(Settings.REVOLT.getUriFor(
                    Settings.REVOLT.LOCKSCREEN_NOTIFICATIONS_POCKET_MODE), false, this);
            resolver.registerContentObserver(Settings.REVOLT.getUriFor(
                    Settings.REVOLT.LOCKSCREEN_NOTIFICATIONS_HIDE_LOW_PRIORITY), false, this);
            resolver.registerContentObserver(Settings.REVOLT.getUriFor(
                    Settings.REVOLT.LOCKSCREEN_NOTIFICATIONS_HIDE_NON_CLEARABLE), false, this);
            resolver.registerContentObserver(Settings.REVOLT.getUriFor(
                    Settings.REVOLT.LOCKSCREEN_NOTIFICATIONS_DISMISS_ALL), false, this);
            resolver.registerContentObserver(Settings.REVOLT.getUriFor(
                    Settings.REVOLT.LOCKSCREEN_NOTIFICATIONS_EXPANDED_VIEW), false, this);
            resolver.registerContentObserver(Settings.REVOLT.getUriFor(
                    Settings.REVOLT.LOCKSCREEN_NOTIFICATIONS_FORCE_EXPANDED_VIEW), false, this);
            resolver.registerContentObserver(Settings.REVOLT.getUriFor(
                    Settings.REVOLT.LOCKSCREEN_NOTIFICATIONS_WAKE_ON_NOTIFICATION), false, this);
            resolver.registerContentObserver(Settings.REVOLT.getUriFor(
                    Settings.REVOLT.LOCKSCREEN_NOTIFICATIONS_HEIGHT), false, this);
            resolver.registerContentObserver(Settings.REVOLT.getUriFor(
                    Settings.REVOLT.LOCKSCREEN_NOTIFICATIONS_OFFSET_TOP), false, this);
            resolver.registerContentObserver(Settings.REVOLT.getUriFor(
                    Settings.REVOLT.LOCKSCREEN_NOTIFICATIONS_PRIVACY_MODE), false, this);
            resolver.registerContentObserver(Settings.REVOLT.getUriFor(
                    Settings.REVOLT.LOCKSCREEN_NOTIFICATIONS_EXCLUDED_APPS), false, this);
            resolver.registerContentObserver(Settings.REVOLT.getUriFor(
                    Settings.REVOLT.LOCKSCREEN_NOTIFICATIONS_COLOR), false, this);
        }
        ...
        private void updateSettings() {
            ...
            hideNonClearable = Settings.REVOLT.getInt(mContext.getContentResolver(),
                    Settings.REVOLT.LOCKSCREEN_NOTIFICATIONS_HIDE_NON_CLEARABLE, hideNonClearable ? 1 : 0) == 1;
            dismissAll = Settings.REVOLT.getInt(mContext.getContentResolver(),
                    Settings.REVOLT.LOCKSCREEN_NOTIFICATIONS_DISMISS_ALL, dismissAll ? 1 : 0) == 1;
            privacyMode = Settings.REVOLT.getInt(mContext.getContentResolver(),
                    Settings.REVOLT.LOCKSCREEN_NOTIFICATIONS_PRIVACY_MODE, privacyMode ? 1 : 0) == 1;
            expandedView = Settings.REVOLT.getInt(mContext.getContentResolver(),
                    Settings.REVOLT.LOCKSCREEN_NOTIFICATIONS_EXPANDED_VIEW, expandedView ? 1 : 0) == 1
                    && !privacyMode;
            forceExpandedView = Settings.REVOLT.getInt(mContext.getContentResolver(),
                    Settings.REVOLT.LOCKSCREEN_NOTIFICATIONS_FORCE_EXPANDED_VIEW, forceExpandedView ? 1 : 0) == 1
                    && !privacyMode;
            wakeOnNotification = Settings.REVOLT.getInt(mContext.getContentResolver(),
                    Settings.REVOLT.LOCKSCREEN_NOTIFICATIONS_WAKE_ON_NOTIFICATION, wakeOnNotification ? 1 : 0) == 1;
            notificationsHeight = Settings.REVOLT.getInt(mContext.getContentResolver(),
                    Settings.REVOLT.LOCKSCREEN_NOTIFICATIONS_HEIGHT, notificationsHeight);
            offsetTop = Settings.REVOLT.getFloat(mContext.getContentResolver(),
                    Settings.REVOLT.LOCKSCREEN_NOTIFICATIONS_OFFSET_TOP, offsetTop);
            String excludedApps = Settings.REVOLT.getString(mContext.getContentResolver(),
                    Settings.REVOLT.LOCKSCREEN_NOTIFICATIONS_EXCLUDED_APPS);
            notificationColor = Settings.REVOLT.getInt(mContext.getContentResolver(),
                    Settings.REVOLT.LOCKSCREEN_NOTIFICATIONS_COLOR, notificationColor);
                ...
                if (!mIsScreenOn) {
                    if (event.values[0] >= ProximitySensor.getMaximumRange()) {
                        if (config.pocketMode && mTimeCovered != 0 && (config.showAlways || mHostView.getNotificationCount() > 0)
                                ...
                                && !QuietHoursHelper.inQuietHours(mContext, Settings.REVOLT.QUIET_HOURS_DIM)) {
                            wakeDevice();
