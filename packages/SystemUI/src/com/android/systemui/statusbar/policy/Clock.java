...
public class Clock extends TextView implements DemoMode {
    ...
    protected void onAttachedToWindow() {
        ...
        if (!mAttached) {
            ...
            resolver.registerContentObserver(Settings.REVOLT
                    .getUriFor(Settings.REVOLT.STATUSBAR_CLOCK_AM_PM_STYLE),
                    false, mSettingsObserver);
            resolver.registerContentObserver(Settings.REVOLT
                    .getUriFor(Settings.REVOLT.STATUSBAR_CLOCK_STYLE),
                    false, mSettingsObserver);
            resolver.registerContentObserver(Settings.REVOLT
                    .getUriFor(Settings.REVOLT.STATUSBAR_CLOCK_COLOR),
                    false, mSettingsObserver);
            resolver.registerContentObserver(Settings.REVOLT
                    .getUriFor(Settings.REVOLT.STATUSBAR_CLOCK_WEEKDAY),
                    false, mSettingsObserver);
            resolver.registerContentObserver(Settings.REVOLT
                    .getUriFor(Settings.REVOLT.STATUSBAR_CLOCK_DATE),
                    false, mSettingsObserver);
        }
    ...
    protected void updateSettings() {
        ...
        mAmPmStyle = Settings.REVOLT.getInt(resolver,
                Settings.REVOLT.STATUSBAR_CLOCK_AM_PM_STYLE, AM_PM_STYLE_GONE);
        mClockStyle = Settings.REVOLT.getInt(resolver,
                Settings.REVOLT.STATUSBAR_CLOCK_STYLE, STYLE_CLOCK_RIGHT);
        mWeekdayStyle = Settings.REVOLT.getInt(resolver,
                Settings.REVOLT.STATUSBAR_CLOCK_WEEKDAY, WEEKDAY_STYLE_GONE);
        mDateStyle = Settings.REVOLT.getInt(resolver,
                Settings.REVOLT.STATUSBAR_CLOCK_DATE, DATE_STYLE_GONE);
        mClockColor = Settings.REVOLT.getInt(resolver,
                Settings.REVOLT.STATUSBAR_CLOCK_COLOR, defaultColor);
