...
public class NotificationPanelView extends PanelView {
    ...
    public NotificationPanelView(Context context, AttributeSet attrs) {
        super(context, attrs);
        mToggleStyle = Settings.REVOLT.getInt(context.getContentResolver(),
                Settings.REVOLT.TOGGLES_STYLE, 0);
    }
    ...
    protected void onFinishInflate() {
        ...
        mEnableObserver = new ContentObserver(mHandler) {
            ...
            public void onChange(boolean selfChange) {
                ...
                mToggleStyle = Settings.REVOLT.getInt(resolver,
                        Settings.REVOLT.TOGGLES_STYLE, 0);
                mSwipeToSwitch = mToggleStyle >= 1 ? false : Settings.REVOLT.getBoolean(resolver,
                        Settings.REVOLT.SWIPE_TO_SWITCH, false);
            }
        };
        ...
        resolver.registerContentObserver(
                Settings.REVOLT.getUriFor(Settings.REVOLT.SWIPE_TO_SWITCH),
                true, mEnableObserver);
