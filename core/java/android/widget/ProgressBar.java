...
public class ProgressBar extends View {
    ...
    public ProgressBar(Context context, AttributeSet attrs, int defStyle, int styleRes) {
        ...
        if (String.valueOf(drawable).contains("android.graphics.drawable.AnimationDrawabl")) {
         boolean IsMirrorMode = Settings.REVOLT.getInt(mContext.getContentResolver(),
                 Settings.REVOLT.PROGRESSBAR_MIRROR, 1) == 1;
         boolean IsReversed = Settings.REVOLT.getInt(mContext.getContentResolver(),
                 Settings.REVOLT.PROGRESSBAR_REVERSE, 1) == 1;
         int tmpSpeed = Settings.REVOLT.getInt(mContext.getContentResolver(),
                 Settings.REVOLT.PROGRESSBAR_SPEED, 0);
         float Speed = ((float) tmpSpeed+1 ) / 10;
         int Width = Settings.REVOLT.getInt(mContext.getContentResolver(),
                 Settings.REVOLT.PROGRESSBAR_WIDTH, 4);
         int Length = Settings.REVOLT.getInt(mContext.getContentResolver(),
                 Settings.REVOLT.PROGRESSBAR_LENGTH, 10);
         int Count = Settings.REVOLT.getInt(mContext.getContentResolver(),
                 Settings.REVOLT.PROGRESSBAR_COUNT, 6);
         int Color1 = Settings.REVOLT.getInt(mContext.getContentResolver(),
                 Settings.REVOLT.PROGRESSBAR_COLOR_1, -1);
         int Color2 = Settings.REVOLT.getInt(mContext.getContentResolver(),
                 Settings.REVOLT.PROGRESSBAR_COLOR_2, -1);
         int Color3 = Settings.REVOLT.getInt(mContext.getContentResolver(),
                 Settings.REVOLT.PROGRESSBAR_COLOR_3, -1);
         int Color4 = Settings.REVOLT.getInt(mContext.getContentResolver(),
                 Settings.REVOLT.PROGRESSBAR_COLOR_4, -1);
