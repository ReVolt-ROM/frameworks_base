...
public class AOKPSearchPanelView extends FrameLayout implements
    ...
    private void setDrawables() {
        ...
        String tgtCenter = Settings.REVOLT.getString(mContentResolver, Settings.REVOLT.SYSTEMUI_NAVRING[0]);
        if (TextUtils.isEmpty(tgtCenter)) {
            Settings.REVOLT.putString(mContentResolver, Settings.REVOLT.SYSTEMUI_NAVRING[0], AwesomeConstant.ACTION_ASSIST.value());
        }
        ...
        void observe() {
            ...
            for (int i = 0; i < 5; i++) {
	            mContentResolver.registerContentObserver(
                    Settings.REVOLT.getUriFor(Settings.REVOLT.SYSTEMUI_NAVRING[i]), false, this);
                mContentResolver.registerContentObserver(
                    Settings.REVOLT.getUriFor(Settings.REVOLT.SYSTEMUI_NAVRING_LONG[i]), false, this);
                mContentResolver.registerContentObserver(
                    Settings.REVOLT.getUriFor(Settings.REVOLT.SYSTEMUI_NAVRING_ICON[i]), false, this);
            }
        }
    ...
    public void updateSettings() {
        ...
        for (int i = 0; i < 5; i++) {
            targetActivities[i] = Settings.REVOLT.getString(
                    mContentResolver, Settings.REVOLT.SYSTEMUI_NAVRING[i]);
            longActivities[i] = Settings.REVOLT.getString(
                    mContentResolver, Settings.REVOLT.SYSTEMUI_NAVRING_LONG[i]);
