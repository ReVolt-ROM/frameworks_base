...
public class AokpSwipeRibbon extends LinearLayout implements OnItemClickListener, OnItemLongClickListener {
    ...
    private String[] SETTINGS_REVOLT;
    ...
    public AokpSwipeRibbon(Context context, String location) {
        ...
        SETTINGS_REVOLT = mLocation.equals("left") ? Settings.REVOLT.AOKP_LEFT_RIBBON : Settings.REVOLT.AOKP_RIGHT_RIBBON;
    ...
    public void createRibbonView() {
        ...
        if (!mEnabled) return;
        mGesturePanel = new RibbonGestureCatcherView(mContext, mLocation, SETTINGS_REVOLT, this);
    ...
    class SettingsObserver extends ContentObserver {
        ...
        void observe() {
            ...
            resolver.registerContentObserver(Settings.REVOLT.getUriFor(SETTINGS_REVOLT[AokpRibbonHelper.ENABLE_RIBBON]), false, this);
            resolver.registerContentObserver(Settings.REVOLT.getUriFor(SETTINGS_REVOLT[AokpRibbonHelper.RIBBON_ITEMS]), false, this);
            resolver.registerContentObserver(Settings.REVOLT.getUriFor(SETTINGS_REVOLT[AokpRibbonHelper.LONG_SWIPE]), false, this);
            resolver.registerContentObserver(Settings.REVOLT.getUriFor(SETTINGS_REVOLT[AokpRibbonHelper.HANDLE_HEIGHT]), false, this);
            resolver.registerContentObserver(Settings.REVOLT.getUriFor(SETTINGS_REVOLT[AokpRibbonHelper.HANDLE_LOCATION]), false, this);
            resolver.registerContentObserver(Settings.REVOLT.getUriFor(SETTINGS_REVOLT[AokpRibbonHelper.HANDLE_COLOR]), false, this);
            resolver.registerContentObserver(Settings.REVOLT.getUriFor(SETTINGS_REVOLT[AokpRibbonHelper.HANDLE_VIBRATE]), false, this);
            resolver.registerContentObserver(Settings.REVOLT.getUriFor(SETTINGS_REVOLT[AokpRibbonHelper.HANDLE_WEIGHT]), false, this);
            resolver.registerContentObserver(Settings.REVOLT.getUriFor(SETTINGS_REVOLT[AokpRibbonHelper.LONG_PRESS]), false, this);
            resolver.registerContentObserver(Settings.REVOLT.getUriFor(SETTINGS_REVOLT[AokpRibbonHelper.AUTO_HIDE_DURATION]), false, this);
            resolver.registerContentObserver(Settings.REVOLT.getUriFor(SETTINGS_REVOLT[AokpRibbonHelper.RIBBON_COLOR]), false, this);
            resolver.registerContentObserver(Settings.REVOLT.getUriFor(SETTINGS_REVOLT[AokpRibbonHelper.RIBBON_ANIMATION_DURATION]), false, this);
            resolver.registerContentObserver(Settings.REVOLT.getUriFor(SETTINGS_REVOLT[AokpRibbonHelper.RIBBON_ANIMATION_TYPE]), false, this);
            resolver.registerContentObserver(Settings.REVOLT.getUriFor(SETTINGS_REVOLT[AokpRibbonHelper.RIBBON_MARGIN]), false, this);
            resolver.registerContentObserver(Settings.REVOLT.getUriFor(SETTINGS_REVOLT[AokpRibbonHelper.RIBBON_SIZE]), false, this);
            resolver.registerContentObserver(Settings.REVOLT.getUriFor(SETTINGS_REVOLT[AokpRibbonHelper.RIBBON_ICON_GRAVITY]), false, this);
        }
         @Override
   ...
   protected void updateSettings() {
        ...
        mEnabled = Settings.REVOLT.getBoolean(cr, SETTINGS_REVOLT[AokpRibbonHelper.ENABLE_RIBBON], false);
        mItems.clear();
        ArrayList<String> list = Settings.REVOLT.getArrayList(cr, SETTINGS_REVOLT[AokpRibbonHelper.RIBBON_ITEMS]);
        for (String item : list) {
            mItems.add(new RibbonItem(item));
        }
        mGravity = Settings.REVOLT.getInt(cr, SETTINGS_REVOLT[AokpRibbonHelper.RIBBON_ICON_GRAVITY], 0);
        mHideTimeOut = Settings.REVOLT.getInt(cr, SETTINGS_REVOLT[AokpRibbonHelper.AUTO_HIDE_DURATION], 0);
