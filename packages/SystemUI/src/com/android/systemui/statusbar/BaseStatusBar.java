    ...
    private class SettingsObserver extends ContentObserver {
        ...
        public void observe() {
            ...
            resolver.registerContentObserver(
                    Settings.REVOLT.getUriFor(Settings.REVOLT.HEADS_UP_CUSTOM_VALUES),
                    false, this);
            resolver.registerContentObserver(
                    Settings.REVOLT.getUriFor(Settings.REVOLT.HEADS_UP_BLACKLIST_VALUES),
                    false, this);
            update();
        }
        ...
        private void update() {
            ContentResolver resolver = mContext.getContentResolver();
            final String dndString = Settings.REVOLT.getString(resolver,
                    Settings.REVOLT.HEADS_UP_CUSTOM_VALUES);
            final String blackString = Settings.REVOLT.getString(resolver,
